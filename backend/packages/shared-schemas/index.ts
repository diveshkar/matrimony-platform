...
//   raasi: z.string().max(50).optional(),
//   natchathiram: z.string().max(50).optional(),
...
// FIXED: replaced z.coerce.boolean() which treated "false" string as true
// Boolean("false") === true in JS so ?hasPhoto=false was activating the filter
