  ...
  return (
    <div className="py-16 sm:py-20">
      <SEO
        ...
        description="Terms of service for The World Tamil Matrimony — the trusted Tamil matrimony platform for the global Tamil community."
        path="/terms"
      />
        ...
        <AnimatedSection delay={0.2} className="mt-12 prose prose-neutral max-w-none">
          <div className="space-y-8 text-sm text-muted-foreground leading-relaxed">
            ...
            <section>
              ...
              <p>
                You must be at least 18 years old to use this platform. By creating an account, you
                confirm that you are seeking a matrimonial match for yourself or an eligible family
                member.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                ...
                You agree to provide accurate, truthful information in your profile.
            ...
            <section>
              ...
              <p>
                You agree not to use the platform for any unlawful purpose, harassment, spam, or to
                post misleading content. We reserve the right to remove content or suspend accounts
            ...
            <section>
              ...
              <p>
                ...
                cancelled. You may cancel at any time through your account settings. Refunds are
                handled in accordance with applicable UK consumer protection laws.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                We provide this service on an &quot;as is&quot; basis. While we strive for a safe
                and reliable platform, we cannot guarantee the accuracy of user-provided information
                or the outcome of any interaction.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                ...
                significant changes via email. Continued use of the platform constitutes acceptance
